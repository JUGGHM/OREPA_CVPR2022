...
def create_Res18_1d5x():
    return ResNet(BasicBlock, [2,2,2,2], num_classes=1000, width_multiplier=1.5)

def create_Res18_2x():
    return ResNet(BasicBlock, [2,2,2,2], num_classes=1000, width_multiplier=2)

def create_Res34():
    return ResNet(BasicBlock, [3,4,6,3], num_classes=1000, width_multiplier=1)

def create_Res50():
    return ResNet(Bottleneck, [3,4,6,3], num_classes=1000, width_multiplier=1)

def create_Res101():
    return ResNet(Bottleneck, [3,4,23,3], num_classes=1000, width_multiplier=1)